    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                ...
                <a class="btn btn-primary" href="{{ url('admin/school/create') }}">
                    Create School
                </a>
                                ...
                                @foreach($schools as $k => $i)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-warning" href="{{ url('admin/school/'.$i->id.'/edit') }}">
                                                Edit
                                            </a>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            {!! Form::open(['method' => 'DELETE','route' => ['school.destroy', $i->id]]) !!}
